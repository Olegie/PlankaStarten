...
Windows-Build setzt das Subsystem auf `5.01` und enthaelt ein Common-Controls-
Manifest, damit Windows XP Schaltflaechen mit nativen Themen zeichnen kann.

Der auf dieser Maschine erzeugte Build kommt aus dem aktuellen Scoop-MinGW-UCRT-
Werkzeugkasten. Der PE-Header ist auf XP ausgerichtet, die Importtabelle
enthaelt aber weiterhin `api-ms-win-crt-*`. Diese konkrete Binaerdatei ist
deshalb nicht als sauberes XP-Paket zu behandeln. Fuer ein echtes XP-Release
muss dieselbe Quelle mit einem XP-faehigen MSVCRT-MinGW oder einem
Visual-Studio-XP-Toolset gebaut und die Importtabelle danach erneut geprueft
werden. Details stehen in [docs/windows_xp.md](docs/windows_xp.md).
